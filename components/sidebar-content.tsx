...
import { getFilteredSidebarSections, SidebarMenuSection } from "@/lib/sidebar";

const AppSidebarContent = ({ role }: { role: string | null }) => {
    const [filteredSections, setFilteredSections] = useState<SidebarMenuSection[]>([]);
