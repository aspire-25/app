...
interface S5AFormProps {
  year: string
}

export function S5AForm({ year }: S5AFormProps) {
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          <CardTitle>Loan Details A</CardTitle>
          <p className="text-sm text-muted-foreground">Primary loan information</p>
        </div>
